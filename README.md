...
## Overview
This demo builds and serves a complete text classification system —
from web scraping to model deployment — all reproducible via Docker and Makefile automation.
